...
include("connection.php");
	...
	if(isset($_SESSION['LOG']))
    {
		...
		{
			$que="INSERT INTO tbl_slider values ('','$image')";
			$result=mysql_query($que);
			$message="Successfully Added Image In Slider";
			$CN="";
		}
	?>
	<!--delete-->
	...
	if(isset($_GET['Id']))
	{
	$del="delete from tbl_slider where Id=$_GET[Id]";
	mysql_query($del);
	}
	?>
<html lang="en">
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                <li><a href="http://www.konarkcomputers.in/" target="_blank"><i class="glyphicon glyphicon-globe"></i> Visit Site</a></li>
          <!--       <li class="dropdown">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <!--    <li><a class="ajax-link" href="ui.html"><i class="glyphicon glyphicon-eye-open"></i><span> UI Features</span></a>
                        ...
                        <li><a class="ajax-link" href="slider.php"><i class="glyphicon glyphicon-picture"></i><span> Image Slider</span></a>
                        </li><!--
                        ...
                        <li class="accordion">
                         ...
                         <li><a class="ajax-link" href="Vidio.php"><i class="glyphicon glyphicon-calendar"></i><span> Vidio</span></a>
                        </li>
                        <li><a class="ajax-link" href="slider.php"><i
                                    class="glyphicon glyphicon-th"></i><span> Slider</span></a></li>-->
               <!--         <li><a href="tour.html"><i class="glyphicon glyphicon-globe"></i><span> Tour</span></a></li>
                        <li><a class="ajax-link" href="icon.html"><i
                                    class="glyphicon glyphicon-star"></i><span> Icons</span></a></li>
                        <li><a href="error.html"><i class="glyphicon glyphicon-ban-circle"></i><span> Error Page</span></a>
                        </li>
						<li><a class="ajax-link" href="filemanager.php"><i class="glyphicon glyphicon-ban-circle"></i><span> File Manager</span></a></li>-->
 ...
 <div class="row">
    ...
    <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-picture"></i> Slider</h2>
				...
				while($record=mysql_fetch_array($sql))
				{
				    ?>
                        <li id="image-1" class="thumbnail">
                            <a style="background:url(<?php echo $record['Image'];?>);" title="Slider Images" href="<?php echo $record['Image'];?>">
                                <img class="grayscale" src="<?php echo $record['Image'];?>" alt="<?php echo $record['Image'];?>">
                            </a>
						</li>
						<a href="slider.php?Id=<?php echo $record['Id'];?>"><img src="images/Delete.png" height="50px" width="50px"></a>
					<?php
				}
				?>
    ...
    <footer class="row">
        ...
        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="http://icontechnology.in/" target="_blank">Icon Technology</a></p>
    </footer>
